...
/**
 * Template for displaying the yesno field
 *
...
<div class="qodef-yesno qodef-field <?php echo esc_attr( $class_print ); ?>" data-option-name="<?php echo esc_attr( $name ); ?>" data-option-type="radiogroup" <?php qode_product_extra_options_for_woocommerce_html_attributes_to_string( $custom_attributes, true ); ?>>
	<?php qode_product_extra_options_for_woocommerce_html_data_to_string( $data, true ); ?>

	<input type="radio" id="<?php echo esc_attr( $field_id ); ?>-yes" name="<?php echo esc_attr( $name ); ?>" value="yes" <?php echo 'yes' === esc_attr( $value ) ? 'checked' : ''; ?>/>
	<label for="<?php echo esc_attr( $field_id ); ?>-yes">
		<?php esc_html_e( 'Yes', 'qode-product-extra-options-for-woocommerce' ); ?>
	</label>
	<input type="radio" id="<?php echo esc_attr( $field_id ); ?>-no" name="<?php echo esc_attr( $name ); ?>" value="no" <?php echo 'no' === esc_attr( $value ) ? 'checked' : ''; ?>/>
