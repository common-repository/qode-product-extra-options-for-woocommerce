...
$plugins_list = qode_product_extra_options_for_woocommerce_get_list_of_other_plugins();
		...
		<?php foreach ( $plugins_list as $plugin_key => $plugin_item ) : ?>
			<div class="qodef-custom-page-plugin">
				...
				<div class="qodef-plugin-buttons-holder">
					<a class="qodef-more-info qodef-body-font-family" href="<?php echo esc_url( $plugin_item['url'] ); ?>" target="_blank"><?php esc_html_e( 'More Info', 'qode-product-extra-options-for-woocommerce' ); ?></a>
					<?php
					$plugin_link_template = qode_product_extra_options_for_woocommerce_plugin_get_plugin_link( $plugin_key, $plugin_item );
