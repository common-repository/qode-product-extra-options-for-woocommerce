...
if ( ! function_exists( 'qode_product_extra_options_for_woocommerce_add_help_custom_options_page' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function qode_product_extra_options_for_woocommerce_add_help_custom_options_page() {
		...
		$custom_page->add_page(
			array(
				'slug'     => 'help',
				'title'    => esc_html__( 'Help', 'qode-product-extra-options-for-woocommerce' ),
				'position' => 2,
				'script'   => false,
	...
	add_action( 'init', 'qode_product_extra_options_for_woocommerce_add_help_custom_options_page', 9 );
}
