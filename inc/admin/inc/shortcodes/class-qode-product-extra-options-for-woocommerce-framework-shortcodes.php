...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Shortcodes {
	...
	private function set_shortcode( Qode_Product_Extra_Options_For_WooCommerce_Framework_Shortcode $shortcode ) {
	...
	public function register() {
		do_action( 'qode_product_extra_options_for_woocommerce_action_framework_before_shortcodes_register' );
		...
		do_action( 'qode_product_extra_options_for_woocommerce_action_framework_after_shortcodes_register' );
	}
}
