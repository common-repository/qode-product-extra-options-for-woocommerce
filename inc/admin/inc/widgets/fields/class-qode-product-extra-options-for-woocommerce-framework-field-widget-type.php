...
abstract class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Widget_Type {
	...
	public function load_assets() {
		do_action( 'qode_product_extra_options_for_woocommerce_action_framework_field_widget_type_load_assets', $this->field_type );
	}
