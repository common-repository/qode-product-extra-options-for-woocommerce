...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Widget_Image extends Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Widget_Type {
	...
	public function render() {
		...
		<span class="qodef-image-uploader" data-file="no">
			...
			<a href="javascript: void(0)" class="button button-secondary qodef-image-remove-btn qodef-hide"><?php esc_html_e( 'Remove', 'qode-product-extra-options-for-woocommerce' ); ?></a>
		</span>
		<?php
	}
}
