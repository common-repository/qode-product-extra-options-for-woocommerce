...
if ( ! function_exists( 'qode_product_extra_options_for_woocommerce_framework_get_google_fonts_json' ) ) {
	/**
	 ...
	 */
	function qode_product_extra_options_for_woocommerce_framework_get_google_fonts_json() {
