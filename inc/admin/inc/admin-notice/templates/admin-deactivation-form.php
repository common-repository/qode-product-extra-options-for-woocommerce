...
?>
<div id="qode-product-extra-options-for-woocommerce-deactivation-modal">
		...
		<div class="qodef-deactivation-modal-content">
			...
			<div class="qodef-deactivation-modal-header">
				<h2 class="qodef-deactivation-modal-title">
					<?php esc_html_e( 'Quick Feedback', 'qode-product-extra-options-for-woocommerce' ); ?>
				</h2>
			</div>
				...
				<div class="qodef-deactivation-modal-form-caption">
					<p>
						...
						printf(
							...
							esc_html__( 'If you have a moment, please share why you are deactivating %s:', 'qode-product-extra-options-for-woocommerce' ),
				...
				<div class="qodef-deactivation-modal-form-options">
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-no_longer_needed" class="qodef-deactivation-modal-form-option-label">
							...
							<span class="qodef-label-text">
								<?php esc_html_e( 'I no longer need the plugin', 'qode-product-extra-options-for-woocommerce' ); ?>
							</span>
						</label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-found_a_better_plugin" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'I found a better plugin', 'qode-product-extra-options-for-woocommerce' ); ?>
							</span>
						</label>
						<input type="text" class="qodef-deactivation-modal-form-option-text" name="reason_found_a_better_plugin" placeholder="<?php esc_attr_e( 'Please share which plugin', 'qode-product-extra-options-for-woocommerce' ); ?>">
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-couldnt_get_plugin_to_work" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'I couldn\'t get plugin to work', 'qode-product-extra-options-for-woocommerce' ); ?>
							</span>
						</label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-temporary_deactivation" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'This is a temporary deactivation', 'qode-product-extra-options-for-woocommerce' ); ?>
							</span>
						</label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-<?php echo esc_attr( $plugin_slug ); ?>_premium" class="qodef-deactivation-modal-form-option-label">
							...
							<span class="qodef-label-text">
								...
								printf(
									// translators: %s - Plugin name.
									esc_html__( 'I have %s Premium', 'qode-product-extra-options-for-woocommerce' ),
									esc_html( $plugin_name )
								);
								?>
							</span>
						...
						<div class="qodef-deactivation-modal-form-option-text">
							...
							printf(
								...
								esc_html__( 'Wait! Don\'t deactivate %1$s. You have to activate both %2$s and %3$s Premium in order for the plugin to work.', 'qode-product-extra-options-for-woocommerce' ),
								esc_html( $plugin_name ),
								esc_html( $plugin_name ),
								esc_html( $plugin_name )
							);
					...
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-other" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'Other', 'qode-product-extra-options-for-woocommerce' ); ?>
							</span>
						</label>
						<input type="text" class="qodef-deactivation-modal-form-option-text" name="reason_other" placeholder="<?php esc_attr_e( 'Please share the reason', 'qode-product-extra-options-for-woocommerce' ); ?>">
					</div>
				</div>
				<div class="qodef-deactivation-modal-form-buttons">
					<button class="qodef-deactivation-modal-button qodef-deactivation-modal-button-submit qodef-btn qodef-btn-solid" ><?php esc_html_e( 'Submit & Deactivate', 'qode-product-extra-options-for-woocommerce' ); ?></button>
					<button class="qodef-deactivation-modal-button qodef-deactivation-modal-button-skip qodef-btn qodef-btn-simple"><?php esc_html_e( 'Skip & Deactivate', 'qode-product-extra-options-for-woocommerce' ); ?></button>
				</div>
				<?php wp_nonce_field( 'qode-product-extra-options-for-woocommerce-deactivation-nonce', 'qode-product-extra-options-for-woocommerce-deactivation-nonce' ); ?>
			</form>
		</div>
	</div>
</div>
