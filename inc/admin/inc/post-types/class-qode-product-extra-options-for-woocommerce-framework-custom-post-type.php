...
abstract class Qode_Product_Extra_Options_For_WooCommerce_Framework_Custom_Post_Type {
	private $base;
	private $slug;
	...
	private function add_taxonomy( Qode_Product_Extra_Options_For_WooCommerce_Framework_Custom_Post_Type_Taxonomy $taxonomy ) {
	...
	public function add_post_taxonomy( $params ) {
		if ( isset( $params['base'] ) && ! empty( $params['base'] ) ) {
			...
			$taxonomy                 = new Qode_Product_Extra_Options_For_WooCommerce_Framework_Custom_Post_Type_Taxonomy( $params );
	...
	public function settings_init() {
		if ( $this->get_public() ) {
			add_settings_field(
				...
				$this->get_name() . ' ' . esc_html__( 'base', 'qode-product-extra-options-for-woocommerce' ),
