...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Custom_Post_Type_Taxonomy {
	...
	private function get_slug() {
		$slugs             = get_option( 'qode_product_extra_options_for_woocommerce_framework_permalinks' );
	...
	public function register() {
		$labels = array_merge(
			array(
				...
				'singular_name'     => sprintf( esc_html__( '%1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->singular_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'search_items'      => sprintf( esc_html__( 'Search %1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->plural_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'all_items'         => sprintf( esc_html__( 'All %1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->plural_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'parent_item'       => sprintf( esc_html__( 'Parent %1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->singular_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'parent_item_colon' => sprintf( esc_html__( 'Parent %1$s %2$s:', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->singular_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'edit_item'         => sprintf( esc_html__( 'Edit %1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->singular_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'update_item'       => sprintf( esc_html__( 'Update %1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->singular_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'add_new_item'      => sprintf( esc_html__( 'Add New %1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->singular_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'new_item_name'     => sprintf( esc_html__( 'New %1$s %2$s Name', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->singular_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'not_found'         => sprintf( esc_html__( 'No %1$s %2$s Found', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->plural_name ),
				// translators: 1. Custom Post Type, 2. Custom Post Type Name.
				'menu_name'         => sprintf( esc_html__( '%1$s %2$s', 'qode-product-extra-options-for-woocommerce' ), $this->post_type_name, $this->plural_name ),
			),
			$this->labels
		);
	...
	public function settings_init() {
		if ( $this->has_archive ) {
			add_settings_field(
				...
				$this->post_type_name . ' ' . $this->singular_name . ' ' . esc_html__( 'base', 'qode-product-extra-options-for-woocommerce' ),
				array(
					$this,
