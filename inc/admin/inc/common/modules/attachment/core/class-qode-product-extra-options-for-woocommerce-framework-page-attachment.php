...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Page_Attachment extends Qode_Product_Extra_Options_For_WooCommerce_Framework_Page {
	...
	public function add_field_element( $params ) {
		...
		qode_product_extra_options_for_woocommerce_framework_get_framework_root()->get_attachment_options()->set_option( $params['name'], $params['default_value'], $params['field_type'] );
