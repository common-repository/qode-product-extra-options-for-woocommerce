...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Options_Attachment extends Qode_Product_Extra_Options_For_WooCommerce_Framework_Options {
	...
	public function init_media_fields() {
		do_action( 'qode_product_extra_options_for_woocommerce_action_framework_custom_media_fields' );
	}
