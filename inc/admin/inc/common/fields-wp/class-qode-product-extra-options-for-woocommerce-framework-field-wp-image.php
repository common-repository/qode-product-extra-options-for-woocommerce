...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_WP_Image extends Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_WP_Type {
			...
			<div class="qodef-image-thumb <?php echo esc_attr( $hide_class ); ?>">
				<?php if ( 'yes' === $this->multiple ) { ?>
					...
					if ( '' !== $this->params['value'] ) {
						...
						?>
						<img class="qodef-single-image" src="<?php echo esc_url( $image_src[0] ); ?>" alt="<?php esc_attr_e( 'Image Thumbnail', 'qode-product-extra-options-for-woocommerce' ); ?>"/>
						<?php
					}
				}
				?>
