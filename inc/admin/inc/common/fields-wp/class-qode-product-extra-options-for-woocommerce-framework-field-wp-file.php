...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_WP_File extends Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_WP_Type {
	...
	public function render_field() {
		...
		<div class="qodef-image-uploader" data-file="yes" data-allowed-type="<?php echo esc_attr( $this->args['allowed_type'] ); ?>">
			<div class="qodef-image-thumb <?php echo ! $has_image ? 'qodef-hide' : ''; ?>">
				...
				if ( '' !== $this->params['value'] ) {
					...
					if ( is_array( $image_src ) ) {
						?>
					<img class="qodef-file-image" src="<?php echo esc_url( $image_src[0] ); ?>" alt="<?php esc_attr_e( 'File Thumbnail', 'qode-product-extra-options-for-woocommerce' ); ?>"/>
						<?php } ?>
			...
			<a class="qodef-image-upload-btn" href="javascript:void(0)" data-frame-title="<?php esc_attr_e( 'Select File', 'qode-product-extra-options-for-woocommerce' ); ?>" data-frame-button-text="<?php esc_attr_e( 'Select File', 'qode-product-extra-options-for-woocommerce' ); ?>"><?php esc_html_e( 'Upload', 'qode-product-extra-options-for-woocommerce' ); ?></a>
