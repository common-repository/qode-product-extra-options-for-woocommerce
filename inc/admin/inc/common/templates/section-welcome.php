...
?>
<div class="qodef-section-wrapper qodef-welcome-section col-12 <?php echo esc_attr( $class ); ?>" <?php qode_product_extra_options_for_woocommerce_inline_attrs( $dependency_data, true ); ?>>
