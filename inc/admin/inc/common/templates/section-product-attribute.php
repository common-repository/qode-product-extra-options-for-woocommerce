		...
		<td colspan="2">
			<div class="qodef-options-heading">
				<div class="qodef-options-heading-icon">
					<img src="<?php echo esc_url( QODE_PRODUCT_EXTRA_OPTIONS_FOR_WOOCOMMERCE_ADMIN_URL_PATH . '/inc/common/modules/admin/assets/img/admin-logo-icon.png' ); ?>" alt="<?php echo esc_attr( $section_title ); ?>" />
				</div>
