...
abstract class Qode_Product_Extra_Options_For_WooCommerce_Framework_Tab implements Qode_Product_Extra_Options_For_WooCommerce_Framework_Tree_Interface, Qode_Product_Extra_Options_For_WooCommerce_Framework_Child_Interface {
	private $scope;
	private $type;
	private $name;
	private $title;
	...
	public function render() {
		...
		qode_product_extra_options_for_woocommerce_framework_template_part( QODE_PRODUCT_EXTRA_OPTIONS_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/tab', '', $params );
	}
}
