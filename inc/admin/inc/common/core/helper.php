...
if ( ! function_exists( 'qode_product_extra_options_for_woocommerce_framework_return_dependency_options_array' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qode_product_extra_options_for_woocommerce_framework_return_dependency_options_array( $scope, $type, $dependency_values = array(), $initial = false, $repeater = false ) {
		$return_array   = array();
				...
				if ( ! empty( $values ) ) {
					...
					if ( $repeater ) {
						...
						if ( ! empty( $rep_key ) && count( $rep_key ) > 2 ) {
							...
							$rep_option = qode_product_extra_options_for_woocommerce_framework_get_option_value( $scope, $type, $rep_main_option );
						...
						$saved_value = qode_product_extra_options_for_woocommerce_framework_get_option_value( $scope, $type, $key );
...
if ( ! function_exists( 'qode_product_extra_options_for_woocommerce_framework_return_widget_dependency_options_array' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qode_product_extra_options_for_woocommerce_framework_return_widget_dependency_options_array( $instance, $dependency_values = array(), $initial = false ) {
		$return_array   = array();
		$options_values = array();
		$data_values    = array();
...
if ( ! function_exists( 'qode_product_extra_options_for_woocommerce_framework_return_dependency_classes' ) ) {
	/**
	 ...
	 * @return string
	 */
	function qode_product_extra_options_for_woocommerce_framework_return_dependency_classes( $show = array(), $hide = array() ) {
		$hide_container = true;
...
if ( ! function_exists( 'qode_product_extra_options_for_woocommerce_framework_return_dependency_data' ) ) {
	/**
	 ...
	 * @return array
	 */
	function qode_product_extra_options_for_woocommerce_framework_return_dependency_data( $show = array(), $hide = array(), $relation = 'and' ) {
