...
abstract class Qode_Product_Extra_Options_For_WooCommerce_Framework_Page implements Qode_Product_Extra_Options_For_WooCommerce_Framework_Tree_Interface {
	private $scope;
	private $type;
	private $slug;
	private $layout;
	...
	public function render() {
		...
		$params['class']      .= ' qodef-page-v4-product-extra-options';

		if ( $this->get_layout() === 'tabbed' ) {
			wp_enqueue_script( 'jquery-ui-tabs' );
		}

		qode_product_extra_options_for_woocommerce_framework_template_part( QODE_PRODUCT_EXTRA_OPTIONS_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/page', $this->get_layout(), $params );
	}
}
