...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Repeater_Inner implements Qode_Product_Extra_Options_For_WooCommerce_Framework_Tree_Interface, Qode_Product_Extra_Options_For_WooCommerce_Framework_Child_Interface {
								...
								<div class="qodef-repeater-inner-fields-holder qodef-second-level clearfix" data-index="<?php echo esc_attr( $counter ); ?>">
									...
									<div class="qodef-repeater-actions-holder">
										...
										<div class="qodef-repeater-remove">
											<a class="qodef-clone-inner-remove" href="#" rel="noopener noreferrer"><?php qode_product_extra_options_for_woocommerce_framework_svg_icon( 'trash' ); ?></a>
										</div>
									</div>
								</div>
								<?php
