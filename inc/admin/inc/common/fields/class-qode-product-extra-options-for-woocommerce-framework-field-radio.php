...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Radio extends Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Type {
			...
			" data-option-name="<?php echo esc_attr( $this->name ); ?>" data-option-type="radiogroup">
				...
				foreach ( $this->options as $key => $value ) {
					...
					<div class="qodef-inline">
						<?php if ( ! $use_images ) { ?>
							<input class="qodef-field" <?php echo esc_attr( $checked ); ?> <?php qode_product_extra_options_for_woocommerce_inline_attrs( $this->data_attrs ); ?> type="radio" id="<?php echo esc_attr( $this->name . $key ); ?>" name="<?php echo esc_attr( $this->name ); ?>" value="<?php echo esc_attr( $key ); ?>">
							<?php if ( ! empty( $label ) ) { ?>
