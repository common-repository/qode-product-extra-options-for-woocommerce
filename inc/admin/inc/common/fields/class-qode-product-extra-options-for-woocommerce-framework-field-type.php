...
abstract class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Type {
	...
	public function __construct( $params ) {
		...
		/* Generate value */
		$value = isset( $params['value'] ) ? $params['value'] : qode_product_extra_options_for_woocommerce_framework_get_option_value( $this->scope, $this->type, $this->name, $this->default_value );
	...
	public function load_assets() {
		do_action( 'qode_product_extra_options_for_woocommerce_action_framework_field_type_load_assets', $this->field_type );
	}

	public function render() {
		?>
		<div class="<?php echo esc_attr( $this->params['class'] ); ?>" id="qodef_<?php echo esc_attr( $this->params['id'] ); ?>" <?php qode_product_extra_options_for_woocommerce_inline_attrs( $this->params['dependency_data'], true ); ?>>
					...
					<div class="qodef-field-desc">
						...
						<?php if ( '' !== $this->description ) { ?>
							<p class="qodef-description qodef-field-description">
								...
								echo qode_product_extra_options_for_woocommerce_framework_wp_kses_html( 'description', $this->description );
								?>
							</p>
						<?php } ?>
					</div>
