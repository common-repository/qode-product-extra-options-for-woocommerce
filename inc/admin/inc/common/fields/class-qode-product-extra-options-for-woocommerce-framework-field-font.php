...
class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Font extends Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Type {
	...
	public function render_field() {
		...
		<select class="<?php echo esc_attr( $this->params['select_class'] ); ?> qodef-field qodef-font-field" name="<?php echo esc_attr( $this->name ); ?>" data-option-name="<?php echo esc_attr( $this->name ); ?>" data-option-type="selectbox">
			<?php
			$fonts = qode_product_extra_options_for_woocommerce_framework_get_complete_fonts_array();
