...
abstract class Qode_Product_Extra_Options_For_WooCommerce_Framework_Field_Attachment_Type {
	...
	public function __construct( $params ) {
		...
		$value           = qode_product_extra_options_for_woocommerce_framework_get_option_value( '', $this->type, $this->name, $this->default_value, $this->post_id );
		$params['value'] = $value;
